...
<template>
  ...
  >
    ...
    <div class="flex flex-col gap-2">
      ...
      <span> Les résumés sont générés par une intelligence artificielle et peuvent contenir des erreurs. Veuillez prendre soin de lire les articles dans la section <b>En savoir plus</b> de chaque catégorie pour obtenir des informations correctes.</span>.
      </p>
    </div>
