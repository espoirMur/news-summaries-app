...
<template>
    <main class="max-w-4xl mx-auto px-6 lg:px-8 mt-8  min-h-[80svh] font-montserrat">
        ...
        <div v-else-if="newsStore.news_detail" class="grid grid-cols-1 gap-8">
            ...
            <div class="flex flex-col gap-4 lg:gap-6 col-span-1 ">
                ...
                <p class="text-sm md:text-base leading-6">{{ newsStore.news_detail.summary }}</p>
            </div>
            <div class="max-w-4xl flex flex-col gap-3">
                ...
                <div>
                    <ul class="ml-4 flex flex-col gap-2">
                        <li v-for="key in Object.keys(newsStore.news_detail.titles)" :key="key">
                            <span class="font-bold">- </span>
                            <a :href="newsStore.news_detail.titles[key]" class="hover:underline font-medium"
                                target="_blank" rel="noopener noreferrer">
                                {{ newsStore.news_detail.titles[key] }}
                            </a>
                        </li>
                    </ul>
                </div>
